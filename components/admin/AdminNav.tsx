...
const navItems = [
  ...
  { name: 'Kuration', icon: CheckCircle, href: '/admin/kuration', color: 'text-black' },
...
export default function AdminNav() {
  ...
  return (
    <nav className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 border-b-4 border-black bg-white sticky top-0 z-50">
      {navItems.map((item) => {
